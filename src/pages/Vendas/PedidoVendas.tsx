  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div>
          <h1 style={{ fontSize: '24px', fontWeight: 700, marginBottom: '4px' }}>Pedido de Vendas</h1>
      ...
      <div className="card list-container" style={{ padding: '24px', backgroundColor: 'var(--bg-secondary)', borderRadius: 'var(--radius-lg)' }}>
        <div style={{ textAlign: 'center', padding: '80px 20px', color: 'var(--text-muted)' }}>
          ...
          <p style={{ marginTop: '8px', maxWidth: '400px', margin: '8px auto' }}>
            O módulo de Pedidos de Venda para faturamento direto de peças no balcão estará disponível em breve.
          </p>
        </div>
      </div>
    </div>
