...
const testFiles = [
  ...
  join(temporaryDirectory, 'tests', 'unidadeMedidaDomain.test.js'),
  join(temporaryDirectory, 'tests', 'descontoDomain.test.js'),
  ...
  join(temporaryDirectory, 'tests', 'metaFaturamentoDomain.test.js'),
  join(temporaryDirectory, 'tests', 'transacaoErroDomain.test.js'),
  join(temporaryDirectory, 'tests', 'osListaValorDomain.test.js'),
  join(temporaryDirectory, 'tests', 'textoCadastroDomain.test.js'),
  join(temporaryDirectory, 'tests', 'estoqueResumoDomain.test.js'),
  join(temporaryDirectory, 'tests', 'filtroListaDomain.test.js'),
  join(temporaryDirectory, 'tests', 'minutaDomain.test.js'),
  join(temporaryDirectory, 'tests', 'notaFiscalVisibilidadeDomain.test.js'),
  join(temporaryDirectory, 'tests', 'reenvioNotaDomain.test.js'),
  join(temporaryDirectory, 'tests', 'destinatarioFiscalDomain.test.js'),
  join(temporaryDirectory, 'tests', 'meusPedidosMobileDomain.test.js'),
  join(temporaryDirectory, 'tests', 'clienteCadastroMobileDomain.test.js'),
  join(temporaryDirectory, 'tests', 'auditoriaSnapshotDomain.test.js'),
  join(temporaryDirectory, 'tests', 'parcelasExibicaoDomain.test.js'),
  join(temporaryDirectory, 'tests', 'buscaProdutoOpcaoDomain.test.js'),
  join(temporaryDirectory, 'tests', 'notaAvulsaDomain.test.js'),
  join(temporaryDirectory, 'tests', 'precificacaoDomain.test.js'),
];
...
try {
  const compileResult = spawnSync(process.execPath, [
    ...
    'tests/unidadeMedidaDomain.test.ts',
    'tests/descontoDomain.test.ts',
    'tests/clienteValidacaoDomain.test.ts',
    'tests/creditoDomain.test.ts',
    'tests/preVendaDomain.test.ts',
    'tests/vendedorPinDomain.test.ts',
    ...
    'tests/metaFaturamentoDomain.test.ts',
    'tests/transacaoErroDomain.test.ts',
    'tests/osListaValorDomain.test.ts',
    'tests/textoCadastroDomain.test.ts',
    'tests/estoqueResumoDomain.test.ts',
    'tests/filtroListaDomain.test.ts',
    'tests/minutaDomain.test.ts',
    'tests/notaFiscalVisibilidadeDomain.test.ts',
    'tests/reenvioNotaDomain.test.ts',
    'tests/destinatarioFiscalDomain.test.ts',
    'tests/meusPedidosMobileDomain.test.ts',
    'tests/clienteCadastroMobileDomain.test.ts',
    'tests/auditoriaSnapshotDomain.test.ts',
    'tests/parcelasExibicaoDomain.test.ts',
    ...
    'src/utils/descontoDomain.ts',
    'src/utils/clienteValidacaoDomain.ts',
    'src/utils/creditoDomain.ts',
    'src/utils/preVendaDomain.ts',
    'src/utils/vendedorPinDomain.ts',
    'src/utils/loginIdentidadeDomain.ts',
    ...
    'src/utils/metaFaturamentoDomain.ts',
